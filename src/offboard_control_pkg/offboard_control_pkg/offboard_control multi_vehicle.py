...
class OffboardControl(Node):
    ...
    def __init__(self) -> None:
        ...
        # Create publisher for Follower 1
        self.offboard_control_mode_publisher_follower1 = self.create_publisher(
            OffboardControlMode, '/px4_2/fmu/in/offboard_control_mode', qos_profile)
        self.trajectory_setpoint_publisher_follower1 = self.create_publisher(
            TrajectorySetpoint, '/px4_2/fmu/in/trajectory_setpoint', qos_profile)
        self.vehicle_command_publisher_follower1 = self.create_publisher(
            VehicleCommand, '/px4_2/fmu/in/vehicle_command', qos_profile)
        # Create subscribers for Follower 1
        self.vehicle_local_position_subscriber_follower1 = self.create_subscription(
            VehicleLocalPosition, '/px4_2/fmu/out/vehicle_local_position', self.vehicle_local_position_callback, qos_profile)
        self.vehicle_status_subscriber_follower1 = self.create_subscription(
            VehicleStatus, '/px4_2/fmu/out/vehicle_status', self.vehicle_status_callback, qos_profile)
        self.gps_position_subscriber_follower1 = self.create_subscription(
            SensorGps, '/px4_2/fmu/out/vehicle_gps_position', self.gps_position_callback, qos_profile)
    ...
    def publish_vehicle_command(self, command, **params) -> None:
        ...
        self.vehicle_command_publisher_follower1.publish(msg)
    ...
    def publish_offboard_control_heartbeat_signal(self):
        ...
        self.offboard_control_mode_publisher_follower1.publish(msg)
    ...
    def publish_position_setpoint(self, x: float, y: float, z: float):
        ...
        self.trajectory_setpoint_publisher_follower1.publish(msg)
        self.get_logger().info(f"Publishing position setpoints for Leader {[x, y, z]}")
        self.get_logger().info(f"Publishing position setpoints for Follower 1 {[x, y, z]}")
